...
public class WaterMarkUtils {  
    ...
    public void mark(String srcImgPath, String outImgPath, Color markContentColor, String waterMarkContent) {  
        try {  
            ...
            g.setFont(font);  
//            int x = srcImgWidth/2 - getWatermarkLength(waterMarkContent, g) - 3;  
...
//        new WaterMarkUtils().mark("d:/postWatermark.jpg", "d:/afterWatermark.jpg", Color.red, "水印效果测试");  
//   }  
}