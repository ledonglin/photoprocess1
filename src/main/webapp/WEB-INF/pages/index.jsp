<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.dj.dy.entity.User,
				com.dj.dy.config.Constant"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<% 
    String context = request.getContextPath();
    User user = (User)request.getSession(false).getAttribute(Constant.USER_CONTEXT);
%>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<body>
	...
	<div class="container">
		<!-- 隐藏用户名，将session注入进去-->
		<input type="hidden" id="userId" value="${userContext.userId}">
